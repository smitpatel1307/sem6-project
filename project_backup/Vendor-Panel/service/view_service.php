...
if(isset($_POST['submit']))
{
	...
	$u=$link->update('service',Array('is_active'=>"0"));
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        <?php
							...
							$sql = $link->rawQuery('select * from service where is_active=? and vendor_id=?',Array("1",$vendor_id));
							if($link->count > 0)
							{
								foreach($sql as $s)
								{
						?>
									<tr>
										...
										<?php echo'<td><a href="update.php?service_id='.$s["service_id"].'"><img src="../icons/update.png" height="20px" width="20px"></a></td>'; ?>
										<td><button type="submit" class="btn btn-primary mr-2" name="submit" value="<?php echo $s['service_id']; ?>">Deactive</button></td>
									</tr>
						<?php
								}
							}
