...
$mail->Password = "8511870099";
		...
		if(isset($_REQUEST['submit']))
		{
			...
			$users = $link->rawQuery('SELECT * from vendor where vendor_email = ?', Array ($email));
			if($link->count == 0)
			{
			...
			else
			{
				...
				$link->update ('vendor', Array ('password' => $newPassword ));
				$var = "<html>
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5" style="background:#353a4ebd;">
              ...
              <h4 style="text-align:center;color:white;font-weight:bold;">Forgot Password?</h4>
			<form method="post" action="#">
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="email" placeholder="Vendor E-mail" name="email" style="color: white;">
                </div>
                ...
                <div class="mt-3">
                  <center><button type="submit" class="btn btn-primary mr-2" name="submit" value="submit" style="color: #212529; background-color: #f8f9fa;  border-color: #f8f9fa;">Submit</button></center>
                </div>
				<a href="login.php" class="auth-link text-black" style="color:white;">Login From Here</a>
                </div>
              </form>
            </div>
          </div>
