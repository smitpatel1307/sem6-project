...
if(isset($_POST['submit']))
{
	...
	$i = $link->insert('category',Array('category_name'=>$category_name));
	if($i)
	{
		...
		{
			$link->where('category_id',$i);
			if($link->update('category',Array('category_image'=>'image/'.$name)))
			{
...
<head>
  ...
  <title>QuickSearch|Admin|Add Category</title>
  <!-- plugins:css -->
  ...
  {	
	...
	var fuData = document.getElementById('cimage');
...
<body>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method='post' enctype='multipart/form-data' name="data" id="data">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="category Name" name='cname' id="cname" onblur="checkcategory(this)">
  ...
  {
	  $.post('validcategory.php',{'category':id.value},function(data,status){
		  if(status==='success'){
			  $('#cspan').html(data);
		  }
	  });
