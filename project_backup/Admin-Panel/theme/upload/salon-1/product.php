...
?>
		<section class="page_header" style="background-image: url('../../../../Vendor-Panel/product/<?php echo $sql['banner_image']; ?>')">
            <div class="container">
				...
				if($link->count > 0)
				{
                    ...
                    <div class="col-sm-4 col-xs-6">
                       <div class="service_item">
                            <img src="../../../../Vendor-Panel/product/<?php echo $s['product_image'] ?>" alt="Services">
                       </div>
					   <br>
					   <div class="post_info">
                                <h3 style="color: #000;"><?php echo $s['title'] ?></h3>
                                <P style="color: #000;"><?php echo $s['description'] ?></P>
								<p style="color: #000;"><?php echo $s['product_price'] ?></p>
                            </div>
                    </div>
					<?php
					}
