...
<body>
				...
				<form action="search.php" method="post">
                    <div class="atbd_generic_header">
                        <div class="atbd_generic_header_title">
							...
							$sql = $link->rawQueryOne('select count(v.vendor_id) as cnt from vendor v,contact c,about a where v.vendor_id=c.vendor_id and v.vendor_id=a.vendor_id and v.approve=?',Array("2"));
							if($link->count > 0)
							{
								$count = $sql['cnt'];
							}
							$rows_page=3; //record per page...
	...
	<?php
				include 'include/connect.php';
				$sql = $link->rawQuery('select v.vendor_id,v.shop_name,c.address,c.phone_no1,c.phone_no2,a.baner_image from vendor v,contact c,about a where v.vendor_id=c.vendor_id and v.vendor_id=a.vendor_id and v.approve=? limit ?,?',Array("2",$si,$rows_page));
				if($link->count > 0)
				{
					foreach($sql as $s)
					{
